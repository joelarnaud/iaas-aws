...
function_name = "lambda-cloudwatch-to-splunk-sbx"
...
s3_existing_package = {
  bucket = "6157-source-code-lambda-cloudwatch-to-splunk-sbx"
  key    = "src/splunk/splunk.zip"
}

s3_existing_package_dr = {
  bucket = "6157-source-code-lambda-cloudwatch-to-splunk-sbx-dr"
  key    = "src/splunk/splunk.zip"
}
