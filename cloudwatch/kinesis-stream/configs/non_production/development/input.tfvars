...
name_ssm_parameter_kinesis_arn = "/nonprod/development/log-cloudwatch-to-splunk/kinesis_arn"
name_ssm_parameter_s3_arn      = "/nonprod/development/log-cloudwatch-to-splunk/s3_kinesis_arn"
name_ssm_parameter_lambda_arn  = "/nonprod/development/log-cloudwatch-to-splunk/lambda_arn"

kinesis_firehose_role_name       = "Custom-KinesisFirehoseRole-dev"
kinesis_firehose_iam_policy_name = "KinesisFirehose-Policy-dev"
firehose_name                    = "kinesis-firehose-to-splunk-dev"

aws_cloudwatch_log_group_name  = "/aws/kinesisfirehose/kinesis-firehose-to-splunk-dev"
aws_cloudwatch_log_stream_name = "SplunkDelivery-dev"
